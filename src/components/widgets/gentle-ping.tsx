    ...
    return (
        <Card className="h-full flex flex-col p-4 border-muted hover:border-sidebar-primary/20 transition-colors shadow-sm bg-card/50 gap-2">
            ...
            <div className="grid grid-cols-2 gap-2 flex-1">
                ...
                {/* Need Space (Replacing 'Thinking' as per default request, or adding?) User said "include need space default is need space". I will replace Thinking with Need Space as primary, and move Thinking or keep it? Space is tight. I'll make it 3 items or swap 'Thinking' for 'Space' if space is tight. Grid cols 2 implies 2 items. I will use 'Need Space' and 'Miss You' as the core ones based on input. */}
                <Button
                    variant="ghost"
